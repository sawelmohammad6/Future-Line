...
Route::get('/products/{slug}', function (string $slug) {
    ...
    $product = [
        ...
        'gallery' => [
            config('frontend-images.products.premium_pangas'),
            config('frontend-images.products.pangas_gallery_2'),
            config('frontend-images.products.pangas_gallery_3'),
            config('frontend-images.products.pangas_gallery_4'),
        ],
    ...
    $related = [
        [
            ...
            'stock' => 'In Stock', 'image' => config('frontend-images.products.tilapia_floating'),
        ],
        [
            ...
            'stock' => 'In Stock', 'image' => config('frontend-images.products.shrimp_premium'),
        ],
        [
            ...
            'stock' => 'In Stock', 'image' => config('frontend-images.products.shing_fish_feed'),
        ],
        [
            ...
            'stock' => 'In Stock', 'image' => config('frontend-images.products.premium_cattle'),
        ],
    ];
...
Route::get('/sellers/{slug}', function (string $slug) {
    ...
    $seller = [
        ...
        'products' => [
            ['name' => 'Premium Pangas Fish Feed', 'slug' => 'premium-pangas-fish-feed', 'brand' => 'GreenLine', 'grade' => 'Grade 1', 'seller' => 'Green Feed Industries', 'location' => 'Dhaka, Bangladesh', 'price' => '৳55 / KG', 'priceTon' => '৳55,000', 'moq' => '500 KG', 'rating' => '4.8', 'stock' => 'In Stock', 'image' => config('frontend-images.products.premium_pangas')],
            ['name' => 'Tilapia Floating Feed', 'slug' => 'tilapia-floating-feed', 'brand' => 'AquaPlus', 'grade' => 'Grade 1', 'seller' => 'Green Feed Industries', 'location' => 'Dhaka, Bangladesh', 'price' => '৳52 / KG', 'priceTon' => '৳52,000', 'moq' => '500 KG', 'rating' => '4.7', 'stock' => 'In Stock', 'image' => config('frontend-images.products.tilapia_floating')],
            ['name' => 'Shrimp Feed Premium', 'slug' => 'shrimp-feed-premium', 'brand' => 'CoastalFeed', 'grade' => 'Grade 1', 'seller' => 'Green Feed Industries', 'location' => 'Dhaka, Bangladesh', 'price' => '৳78 / KG', 'priceTon' => '৳78,000', 'moq' => '300 KG', 'rating' => '4.9', 'stock' => 'In Stock', 'image' => config('frontend-images.products.shrimp_premium')],
            ['name' => 'Shing Fish Feed', 'slug' => 'shing-fish-feed', 'brand' => 'AquaPlus', 'grade' => 'Grade 2', 'seller' => 'Green Feed Industries', 'location' => 'Dhaka, Bangladesh', 'price' => '৳58 / KG', 'priceTon' => '৳58,000', 'moq' => '500 KG', 'rating' => '4.6', 'stock' => 'In Stock', 'image' => config('frontend-images.products.shing_fish_feed')],
            ['name' => 'Dairy Cattle Feed', 'slug' => 'dairy-cattle-feed', 'brand' => 'DeltaFeed', 'grade' => 'Grade 1', 'seller' => 'Green Feed Industries', 'location' => 'Dhaka, Bangladesh', 'price' => '৳42 / KG', 'priceTon' => '৳42,000', 'moq' => '1,000 KG', 'rating' => '4.8', 'stock' => 'In Stock', 'image' => config('frontend-images.products.dairy_cattle')],
            ['name' => 'Broiler Starter Feed', 'slug' => 'broiler-starter-feed', 'brand' => 'RoyalMix', 'grade' => 'Grade 1', 'seller' => 'Green Feed Industries', 'location' => 'Dhaka, Bangladesh', 'price' => '৳61 / KG', 'priceTon' => '৳61,000', 'moq' => '500 KG', 'rating' => '4.6', 'stock' => 'In Stock', 'image' => config('frontend-images.products.broiler_starter')],
            ['name' => 'Layer Feed', 'slug' => 'layer-feed', 'brand' => 'GoldenGrain', 'grade' => 'Grade 1', 'seller' => 'Green Feed Industries', 'location' => 'Dhaka, Bangladesh', 'price' => '৳49 / KG', 'priceTon' => '৳49,000', 'moq' => '500 KG', 'rating' => '4.7', 'stock' => 'In Stock', 'image' => config('frontend-images.products.layer_feed')],
            ['name' => 'Fish Meal', 'slug' => 'fish-meal', 'brand' => 'MarineSource', 'grade' => 'Grade 1', 'seller' => 'Green Feed Industries', 'location' => 'Dhaka, Bangladesh', 'price' => '৳112 / KG', 'priceTon' => '৳112,000', 'moq' => '500 KG', 'rating' => '4.8', 'stock' => 'In Stock', 'image' => config('frontend-images.products.fish_meal')],
        ],
        'reviews' => [
        ...
        'gallery' => [
            ['label' => 'Factory', 'image' => config('frontend-images.companies.green_feed_factory')],
            ['label' => 'Warehouse', 'image' => config('frontend-images.companies.green_feed_warehouse')],
            ['label' => 'Products', 'image' => config('frontend-images.products.premium_pangas')],
            ['label' => 'Packaging', 'image' => config('frontend-images.companies.green_feed_packaging')],
            ['label' => 'Team', 'image' => config('frontend-images.companies.green_feed_team')],
            ['label' => 'Facility', 'image' => config('frontend-images.companies.green_feed_facility')],
        ],
    ];
...
Route::get('/companies/{slug}', function (string $slug) {
    ...
    $company = [
        ...
        'products' => [
            ['name' => 'Premium Pangas Fish Feed', 'slug' => 'premium-pangas-fish-feed', 'brand' => 'GreenLine', 'grade' => 'Grade 1', 'seller' => 'Bengal Agro Foods', 'location' => 'Gazipur, Bangladesh', 'price' => '৳55 / KG', 'priceTon' => '৳55,000', 'moq' => '500 KG', 'rating' => '4.8', 'stock' => 'In Stock', 'image' => config('frontend-images.products.premium_pangas')],
            ['name' => 'Tilapia Floating Feed', 'slug' => 'tilapia-floating-feed', 'brand' => 'AquaPlus', 'grade' => 'Grade 1', 'seller' => 'Bengal Agro Foods', 'location' => 'Gazipur, Bangladesh', 'price' => '৳52 / KG', 'priceTon' => '৳52,000', 'moq' => '500 KG', 'rating' => '4.7', 'stock' => 'In Stock', 'image' => config('frontend-images.products.tilapia_floating')],
            ['name' => 'Dairy Cattle Feed', 'slug' => 'dairy-cattle-feed', 'brand' => 'DeltaFeed', 'grade' => 'Grade 1', 'seller' => 'Bengal Agro Foods', 'location' => 'Gazipur, Bangladesh', 'price' => '৳42 / KG', 'priceTon' => '৳42,000', 'moq' => '1,000 KG', 'rating' => '4.8', 'stock' => 'In Stock', 'image' => config('frontend-images.products.dairy_cattle')],
            ['name' => 'Broiler Starter Feed', 'slug' => 'broiler-starter-feed', 'brand' => 'RoyalMix', 'grade' => 'Grade 1', 'seller' => 'Bengal Agro Foods', 'location' => 'Gazipur, Bangladesh', 'price' => '৳61 / KG', 'priceTon' => '৳61,000', 'moq' => '500 KG', 'rating' => '4.6', 'stock' => 'In Stock', 'image' => config('frontend-images.products.broiler_starter')],
            ['name' => 'Layer Feed Premium', 'slug' => 'layer-feed', 'brand' => 'GoldenGrain', 'grade' => 'Grade 1', 'seller' => 'Bengal Agro Foods', 'location' => 'Gazipur, Bangladesh', 'price' => '৳49 / KG', 'priceTon' => '৳49,000', 'moq' => '500 KG', 'rating' => '4.7', 'stock' => 'In Stock', 'image' => config('frontend-images.products.layer_feed')],
            ['name' => 'Fish Meal', 'slug' => 'fish-meal', 'brand' => 'MarineSource', 'grade' => 'Grade 1', 'seller' => 'Bengal Agro Foods', 'location' => 'Gazipur, Bangladesh', 'price' => '৳112 / KG', 'priceTon' => '৳112,000', 'moq' => '500 KG', 'rating' => '4.8', 'stock' => 'In Stock', 'image' => config('frontend-images.products.fish_meal')],
            ['name' => 'Shrimp Feed Premium', 'slug' => 'shrimp-feed-premium', 'brand' => 'GreenLine', 'grade' => 'Grade 1', 'seller' => 'Bengal Agro Foods', 'location' => 'Gazipur, Bangladesh', 'price' => '৳78 / KG', 'priceTon' => '৳78,000', 'moq' => '300 KG', 'rating' => '4.9', 'stock' => 'In Stock', 'image' => config('frontend-images.products.shrimp_premium')],
            ['name' => 'Soybean Meal', 'slug' => 'soybean-meal', 'brand' => 'MarineSource', 'grade' => 'Feed Grade', 'seller' => 'Bengal Agro Foods', 'location' => 'Gazipur, Bangladesh', 'price' => '৳65 / KG', 'priceTon' => '৳65,000', 'moq' => '1,000 KG', 'rating' => '4.7', 'stock' => 'In Stock', 'image' => config('frontend-images.products.soybean_meal')],
        ],
        'gallery' => [
            ['label' => 'Factory', 'image' => config('frontend-images.companies.bengal_agro_factory')],
            ['label' => 'Warehouse', 'image' => config('frontend-images.companies.bengal_agro_warehouse')],
            ['label' => 'Production Line', 'image' => config('frontend-images.companies.bengal_agro_production_line')],
            ['label' => 'Packaging Area', 'image' => config('frontend-images.companies.bengal_agro_packaging')],
            ['label' => 'Product Storage', 'image' => config('frontend-images.companies.bengal_agro_storage')],
            ['label' => 'Testing Facility', 'image' => config('frontend-images.companies.bengal_agro_testing')],
        ],
        'documents' => [
...
Route::get('/traders/{slug}', function (string $slug) {
    ...
    $trader = [
        ...
        'products' => [
            ['name' => 'Soybean Meal', 'origin' => 'Argentina', 'grade' => 'Feed Grade', 'quantity' => '1,000 Ton', 'price' => '৳XX / KG', 'availability' => 'Available', 'image' => config('frontend-images.products.soybean_meal')],
            ['name' => 'Maize / Corn', 'origin' => 'Brazil', 'grade' => 'Feed Grade', 'quantity' => '800 Ton', 'price' => '৳XX / KG', 'availability' => 'Available', 'image' => config('frontend-images.products.maize')],
            ['name' => 'Fish Meal', 'origin' => 'Vietnam', 'grade' => 'Feed Grade', 'quantity' => '500 Ton', 'price' => '৳XX / KG', 'availability' => 'Available', 'image' => config('frontend-images.products.fish_meal')],
            ['name' => 'DDGS', 'origin' => 'India', 'grade' => 'Feed Grade', 'quantity' => '600 Ton', 'price' => '৳XX / KG', 'availability' => 'Available', 'image' => config('frontend-images.products.ddgs')],
        ],
        'countries' => [
