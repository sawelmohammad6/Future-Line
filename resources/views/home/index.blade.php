...
@php
    ...
    $categories = [
        ['name' => 'Fish Feed', 'description' => 'Balanced nutrition for commercial aquaculture operations.', 'subcategories' => 'Pangas, Tilapia, Shrimp, Shing, Magur, Pabda', 'count' => '128', 'image' => config('frontend-images.categories.fish_feed')],
        ['name' => 'Cattle Feed', 'description' => 'Performance-focused feed for healthy, productive livestock.', 'subcategories' => 'Dairy, Beef Cattle, Calf', 'count' => '86', 'image' => config('frontend-images.categories.cattle_feed')],
        ['name' => 'Poultry Feed', 'description' => 'Reliable feed solutions for every stage of poultry growth.', 'subcategories' => 'Broiler, Layer, Chick', 'count' => '94', 'image' => config('frontend-images.categories.poultry_feed')],
        ['name' => 'Duck Feed', 'description' => 'Specialized nutrition to support healthy duck farming.', 'subcategories' => 'Starter, Grower, Layer', 'count' => '32', 'image' => config('frontend-images.categories.duck_feed')],
        ['name' => 'Animal Feed', 'description' => 'Quality feed for small ruminants and other farm animals.', 'subcategories' => 'Goat, Sheep, Other Animal Feed', 'count' => '57', 'image' => config('frontend-images.categories.animal_feed')],
        ['name' => 'Feed Raw Materials', 'description' => 'Essential ingredients sourced for dependable feed production.', 'subcategories' => 'Fish Meal, Soybean Meal, Maize, Rice Polish, Wheat Bran', 'count' => '143', 'image' => config('frontend-images.categories.raw_materials')],
    ];
    $featuredProducts = [
        ['slug' => 'premium-pangas-fish-feed', 'name' => 'Premium Pangas Fish Feed', 'grade' => 'Grade 1', 'seller' => 'Aqua Nutrition Ltd.', 'price' => '৳55 / KG', 'moq' => '500 KG', 'rating' => '4.8', 'image' => config('frontend-images.products.premium_pangas')],
        ['slug' => 'tilapia-floating-feed', 'name' => 'Tilapia Floating Feed', 'grade' => 'Grade A', 'seller' => 'Bluewater Feeds', 'price' => '৳52 / KG', 'moq' => '500 KG', 'rating' => '4.7', 'image' => config('frontend-images.products.tilapia_floating')],
        ['slug' => 'shrimp-feed-premium', 'name' => 'Shrimp Feed Premium', 'grade' => 'Export Grade', 'seller' => 'Coastal Feed Mills', 'price' => '৳78 / KG', 'moq' => '300 KG', 'rating' => '4.9', 'image' => config('frontend-images.products.shrimp_premium')],
        ['slug' => 'dairy-cattle-feed', 'name' => 'Dairy Cattle Feed', 'grade' => 'High Energy', 'seller' => 'Green Field Agro', 'price' => '৳42 / KG', 'moq' => '1,000 KG', 'rating' => '4.8', 'image' => config('frontend-images.products.dairy_cattle')],
        ['slug' => 'broiler-starter-feed', 'name' => 'Broiler Starter Feed', 'grade' => 'Starter Formula', 'seller' => 'Prime Poultry Feed', 'price' => '৳61 / KG', 'moq' => '500 KG', 'rating' => '4.6', 'image' => config('frontend-images.products.broiler_starter')],
        ['slug' => 'layer-feed', 'name' => 'Layer Feed', 'grade' => 'Premium Layer', 'seller' => 'Golden Grain Ltd.', 'price' => '৳49 / KG', 'moq' => '500 KG', 'rating' => '4.7', 'image' => config('frontend-images.products.layer_feed')],
        ['slug' => 'soybean-meal', 'name' => 'Soybean Meal', 'grade' => 'Protein 46%', 'seller' => 'Delta Commodities', 'price' => '৳68 / KG', 'moq' => '1,000 KG', 'rating' => '4.9', 'image' => config('frontend-images.products.soybean_meal')],
        ['slug' => 'fish-meal', 'name' => 'Fish Meal', 'grade' => 'Protein 60%', 'seller' => 'Marine Source BD', 'price' => '৳112 / KG', 'moq' => '500 KG', 'rating' => '4.8', 'image' => config('frontend-images.products.fish_meal')],
    ];
    $sellers = [
    ...
    $rawMaterials = [
        ['slug' => 'fish-meal', 'name' => 'Fish Meal', 'description' => 'High-protein marine feed ingredient.', 'origin' => 'Peru', 'price' => '৳78 / KG', 'moq' => '1,000 KG', 'image' => config('frontend-images.products.fish_meal')],
        ['slug' => 'soybean-meal', 'name' => 'Soybean Meal', 'description' => 'Protein-rich plant-based feed ingredient.', 'origin' => 'Brazil', 'price' => '৳68 / KG', 'moq' => '1,000 KG', 'image' => config('frontend-images.products.soybean_meal')],
        ['slug' => 'maize', 'name' => 'Maize', 'description' => 'Energy-dense grain for balanced feed formulas.', 'origin' => 'India', 'price' => '৳38 / KG', 'moq' => '2 Ton', 'image' => config('frontend-images.products.maize')],
        ['slug' => 'rice-polish', 'name' => 'Rice Polish', 'description' => 'Nutritious milling by-product for animal diets.', 'origin' => 'Bangladesh', 'price' => '৳31 / KG', 'moq' => '2 Ton', 'image' => config('frontend-images.products.rice_polish')],
        ['slug' => 'rice-bran', 'name' => 'Rice Bran', 'description' => 'Natural source of energy and fiber.', 'origin' => 'Bangladesh', 'price' => '৳29 / KG', 'moq' => '2 Ton', 'image' => config('frontend-images.products.rice_bran')],
        ['slug' => 'wheat-bran', 'name' => 'Wheat Bran', 'description' => 'Fiber-rich cereal ingredient for feed blends.', 'origin' => 'India', 'price' => '৳34 / KG', 'moq' => '2 Ton', 'image' => config('frontend-images.products.wheat_bran')],
        ['slug' => 'ddgs', 'name' => 'DDGS', 'description' => 'Distillers grain with valuable protein content.', 'origin' => 'USA', 'price' => '৳52 / KG', 'moq' => '1 Ton', 'image' => config('frontend-images.products.ddgs')],
        ['slug' => 'dorb', 'name' => 'DORB', 'description' => 'De-oiled rice bran for efficient feed mixes.', 'origin' => 'Bangladesh', 'price' => '৳27 / KG', 'moq' => '2 Ton', 'image' => config('frontend-images.products.dorb')],
        ['slug' => 'cgm', 'name' => 'CGM', 'description' => 'Corn gluten meal with concentrated protein.', 'origin' => 'Argentina', 'price' => '৳74 / KG', 'moq' => '1 Ton', 'image' => config('frontend-images.products.cgm')],
        ['slug' => 'fish-oil', 'name' => 'Fish Oil', 'description' => 'Marine oil source for nutrition and energy.', 'origin' => 'Peru', 'price' => '৳145 / KG', 'moq' => '500 KG', 'image' => config('frontend-images.products.fish_oil')],
        ['slug' => 'premix', 'name' => 'Premix', 'description' => 'Essential vitamin and mineral feed blend.', 'origin' => 'Netherlands', 'price' => '৳220 / KG', 'moq' => '100 KG', 'image' => config('frontend-images.products.premix')],
        ['slug' => 'limestone', 'name' => 'Limestone', 'description' => 'Calcium source for livestock and poultry feed.', 'origin' => 'Bangladesh', 'price' => '৳12 / KG', 'moq' => '5 Ton', 'image' => config('frontend-images.products.limestone')],
    ];
    $testimonials = [
        ['name' => 'Rahim Uddin', 'business' => 'Green Valley Fish Farm', 'location' => 'Mymensingh', 'product' => 'Premium Pangas Fish Feed', 'rating' => '4.9', 'review' => 'Since switching to this feed, our farm has seen more consistent results and reliable supply.', 'photo' => config('frontend-images.testimonials.rahim_uddin'), 'productImage' => config('frontend-images.products.premium_pangas')],
        ['name' => 'Fatema Begum', 'business' => 'Savar Dairy Farm', 'location' => 'Savar, Dhaka', 'product' => 'Dairy Cattle Feed', 'rating' => '4.8', 'review' => 'The supplier information was clear, and the feed quality has been dependable for our dairy herd.', 'photo' => config('frontend-images.testimonials.fatema_begum'), 'productImage' => config('frontend-images.products.dairy_cattle')],
        ['name' => 'Abdul Karim', 'business' => 'Karim Aqua Enterprise', 'location' => 'Rajshahi', 'product' => 'Tilapia Floating Feed', 'rating' => '4.9', 'review' => 'Finding verified sellers in one place has made our regular feed sourcing much easier.', 'photo' => config('frontend-images.testimonials.abdul_karim'), 'productImage' => config('frontend-images.products.tilapia_floating')],
        ['name' => 'Sultana Akter', 'business' => 'Meghna Poultry Farm', 'location' => 'Cumilla', 'product' => 'Broiler Starter Feed', 'rating' => '4.7', 'review' => 'We can compare product grades and quantities before deciding, which gives us confidence.', 'photo' => config('frontend-images.testimonials.sultana_akter'), 'productImage' => config('frontend-images.products.broiler_starter')],
        ['name' => 'Jamal Hossain', 'business' => 'Barind Livestock', 'location' => 'Bogura', 'product' => 'Soybean Meal', 'rating' => '4.8', 'review' => 'The marketplace helped us identify a suitable bulk supplier with transparent pricing.', 'photo' => config('frontend-images.testimonials.jamal_hossain'), 'productImage' => config('frontend-images.products.soybean_meal')],
        ['name' => 'Nasrin Sultana', 'business' => 'Coastal Shrimp Hatchery', 'location' => 'Satkhira', 'product' => 'Shrimp Feed Premium', 'rating' => '4.9', 'review' => 'Reliable product details and a consistent supplier have improved our purchase planning.', 'photo' => config('frontend-images.testimonials.nasrin_sultana'), 'productImage' => config('frontend-images.products.shrimp_premium')],
    ];
    $videoStories = [
        ['title' => 'How Reliable Feed Supply Changed Our Farm', 'name' => 'Abdul Karim', 'location' => 'Rajshahi', 'category' => 'Fish Feed Buyer', 'image' => config('frontend-images.testimonials.fish_feed_story')],
        ['title' => 'Building a Better Dairy Supply Relationship', 'name' => 'Fatema Begum', 'location' => 'Savar, Dhaka', 'category' => 'Cattle Feed Buyer', 'image' => config('frontend-images.testimonials.cattle_feed_story')],
        ['title' => 'Sourcing Ingredients With More Confidence', 'name' => 'Jamal Hossain', 'location' => 'Bogura', 'category' => 'Feed Manufacturer', 'image' => config('frontend-images.testimonials.raw_materials_story')],
    ];
    $processSteps = [
    ...
    $updates = [
        ['tag' => 'Buying Guide', 'date' => 'May 18, 2026', 'title' => 'How to Choose the Right Fish Feed Grade', 'excerpt' => 'Key details to review when selecting feed for a healthy and productive aquaculture operation.', 'image' => config('frontend-images.updates.fish_feed_grade')],
        ['tag' => 'Raw Materials', 'date' => 'May 12, 2026', 'title' => 'Understanding Feed Raw Material Quality', 'excerpt' => 'A practical overview of origin, grade and quality information for feed ingredients.', 'image' => config('frontend-images.updates.raw_material_quality')],
        ['tag' => 'Trade Guide', 'date' => 'May 05, 2026', 'title' => 'Guide to Buying Feed in Bulk', 'excerpt' => 'Plan quantities, compare suppliers and make informed decisions for bulk feed purchases.', 'image' => config('frontend-images.updates.bulk_feed_buying')],
        ['tag' => 'Marketplace', 'date' => 'April 28, 2026', 'title' => 'Future Line Trading Marketplace Updates', 'excerpt' => 'Explore the latest improvements to discovering products and verified trade partners.', 'image' => config('frontend-images.updates.marketplace_updates')],
    ];
@endphp
                ...
                <div class="relative mx-auto w-full max-w-xl lg:mx-0 lg:max-w-none">
                    ...
                    <div class="relative overflow-hidden border border-slate-200 bg-white p-2 shadow-xl shadow-emerald-950/10">
                        <div class="relative overflow-hidden bg-emerald-950">
                            <img src="{{ asset(config('frontend-images.hero.marketplace')) }}" alt="Agricultural field representing the Future Line Trading marketplace" class="h-[330px] w-full object-cover sm:h-[420px] lg:h-[530px]">
